package com.example.wordlskills.colorito1.utilidades;
...
public class Utilidades {
    ...
    public static final String CREAR_TABLA_PUNTAJES = "CREATE TABLE " + TABLA_PUNTAJES + " (" + DESPLEGADAS + " VARCHAR, " + CORRECTAS + " VARCHAR, " + INCORRECTAS + " VARCHAR, " + INTENTOS + " VARCHAR)";
